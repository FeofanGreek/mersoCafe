...
class _CartScreenState extends State<CartView> {
  ...
  makeOrder() async {
    ...
    try {
      ...
      NullingMenu ();
      //textMainScreen = 'Ευχαριστούμε για την παραγγελία σας! \n'
      //    'Μπορείτε να παρακολουθείτε την κατάσταση στο ιστορικό παραγγελιών. \n'
      //    'Εάν κάτι πάει στραβά, θα επικοινωνήσουμε μαζί σας.';
      //textMainScreen = response.body;
