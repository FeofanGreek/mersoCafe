  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
                  ...
                  children: <Widget>[
                    ...
                    Row(
                        ...
                        children: <Widget>[
                          isAdmin||isManager?FlatButton(
                            ...
                            splashColor: Colors.blueAccent,
                            onPressed: () {_sendRequestOrdersList(0); filterOrders = 0; orderComment='Αποδεκτό';},
                            child: Text(
                              "Αποδεκτό",
                          ...
                          isAdmin||isManager?FlatButton(
                            ...
                            padding: EdgeInsets.all(8.0),
                            splashColor: Colors.blueAccent,
                            onPressed: () {_sendRequestOrdersList(2); filterOrders = 2; orderComment='Προετοιμασία';},
                            child: Text(
                              "Προετοιμασία",
                              style: TextStyle(fontSize: 12.0),
                            ),
                          ...
                          isAdmin||isManager?FlatButton(
                            ...
                            padding: EdgeInsets.all(8.0),
                            splashColor: Colors.blueAccent,
                            onPressed: () {_sendRequestOrdersList(3); filterOrders = 3; orderComment='Έτοιμο για έκδοση';},
                            child: Text(
                              "Έτοιμο για έκδοση",
                              style: TextStyle(fontSize: 12.0),
                            ),
                    ...
                    isAdmin||isManager?Row(
                          ...
                          FlatButton(
                            ...
                            padding: EdgeInsets.all(8.0),
                            splashColor: Colors.blueAccent,
                            onPressed: () {_sendRequestOrdersList(4); filterOrders = 4; orderComment='Ολοκληρώθηκε';},
                            child: Text(
                              "Ολοκληρώθηκε",
                              style: TextStyle(fontSize: 12.0),
                            ),
                          ...
                          FlatButton(
                            ...
                            padding: EdgeInsets.all(8.0),
                            splashColor: Colors.blueAccent,
                            onPressed: () {_sendRequestOrdersList(1); filterOrders = 1; orderComment='Ακυρώθηκε';},
                            child: Text(
                              "Ακυρώθηκε",
                              style: TextStyle(fontSize: 12.0),
                            ),
                        ...
                        itemBuilder: (BuildContext context, int index) {
                          return Container(
                              ...
                              GestureDetector(
                                  ...
                                  :Container(
                                  child:Text('Δεν υπάρχουν παραγγελίες που απαιτούν δράση', style: TextStyle(fontSize: 20.0,color: Colors.black87),textAlign: TextAlign.center,)
                              ),
                          );
                        }
                    ):Container(
      ...
      /*floatingActionButton: isAdmin?FloatingActionButton.extended(
        ...
        tooltip: 'Increment',
        label: Text('Staff', style: TextStyle(fontSize: 14.0, color: Colors.black),textAlign: TextAlign.justify,),
      ...
      FloatingActionButton(
        onPressed:() {},
        //tooltip: 'Increment',
        //label: Text('', style: TextStyle(fontSize: 14.0, color: Colors.black),textAlign: TextAlign.justify,),
        //icon: Icon(Icons.account_box),
