                          ...
                          return Container(
                              ...
                              child: parsedJsonStaffList[index]['iduser']!=0?Column(
                                 ...
                                 Column(
                                  ...
                                  child:Text('Δεν έχει προστεθεί ακόμη προσωπικό\nΕάν ο υπάλληλός σας έχει εγκαταστήσει την εφαρμογή, απλώς ξεκινήστε να εισάγετε τον αριθμό κινητού τηλεφώνου του για να τον προσθέσετε στη λίστα.', style: TextStyle(fontSize: 20.0,color: Colors.black87),textAlign: TextAlign.center,)
                              ),
                          );
                        }
                    ):Container(
